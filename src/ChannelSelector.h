  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ChannelSelector(RTC::Manager* manager);
 ...
 private:
  ...
  std::string m_endian;     //!< config parameter
  int m_channels,m_selectch;   //!< config parameter(InputChannelNumbers)
  int m_bytesize;
//  int m_noise_end;
...
public:
  ...
  /*!
   * @brief ChannelSelectorManager start
   */
  void start();
private:
  ...
  /*!
   * @brief ChannelSelectorManager initialize
   *
   * @param manager Maneger Object
   */
...
{
  /*!
   * @brief ChannelSelector initialize
   *
   * @param manager Maneger Object
   */
  DLL_EXPORT void ChannelSelectorInit(RTC::Manager* manager);
};
